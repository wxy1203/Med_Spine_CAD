...
#ifdef _ENABLE_MFC_INTERFACE_INIT_FILE

//[7_6 10:11:44 ]: 
//[9_17 16:02:03 ]:#include <winapifamily.h>
//
//
//#if (_MSC_VER > 1000)
#	pragma once
...
#define C_SPN_ASSERT(e) typedef char __C_ASSERT__[(e)?1:-1]
#else
#define C_SPN_ASSERT(e)
#endif // 
...
//
C_SPN_ASSERT(sizeof(USHORT) == 2);
C_SPN_ASSERT(sizeof(INT) == 4);
C_SPN_ASSERT(sizeof(UINT) == 4);
C_SPN_ASSERT(sizeof(LONG) == 4);
C_SPN_ASSERT(sizeof(ULONG) == 4);
C_SPN_ASSERT(sizeof(UINT_PTR) == sizeof(ULONG_PTR));
...
{
    C_SPN_ASSERT(sizeof(INT) == sizeof(LONG));
...
LongPtrToInt(
    ...
    _Out_ _Deref_out_range_(==, lOperand) INT* piResult)
{
    C_SPN_ASSERT(sizeof(INT) == sizeof(LONG_PTR));
    *piResult = (INT)lOperand;
    return S_OK;
}   
#endif // 
...
LongPtrToIntPtr(
    ...
    _Out_ _Deref_out_range_(==, lOperand) INT_PTR* piResult)
{
    C_SPN_ASSERT(sizeof(LONG_PTR) == sizeof(INT_PTR));
...
{
    C_SPN_ASSERT(sizeof(ULONG) == sizeof(UINT));
...
{
    C_SPN_ASSERT(sizeof(UINT_PTR) > sizeof(ULONG));
...
{
    C_SPN_ASSERT(sizeof(LONG_PTR) > sizeof(ULONG));
...
ULongPtrToUInt(
    ...
    _Out_ _Deref_out_range_(==, ulOperand) UINT* puResult)
{
    C_SPN_ASSERT(sizeof(ULONG_PTR) == sizeof(UINT));
    *puResult = (UINT)ulOperand;    
    return S_OK;
}
#endif // 
...
{
    C_SPN_ASSERT(sizeof(LONG) > sizeof(INT8));
...
{
    C_SPN_ASSERT(sizeof(LONG) > sizeof(short));
...
{
    C_SPN_ASSERT(sizeof(LONGLONG) > sizeof(INT));
...
{
    C_SPN_ASSERT(sizeof(LONGLONG) > sizeof(INT_PTR));
...
{
    C_SPN_ASSERT(sizeof(LONGLONG) > sizeof(LONG));
...
{
    C_SPN_ASSERT(sizeof(LONGLONG) > sizeof(LONG_PTR));
...
{
    C_SPN_ASSERT(sizeof(LONGLONG) > sizeof(ptrdiff_t));
...
{
    C_SPN_ASSERT(sizeof(LONGLONG) > sizeof(SSIZE_T));
